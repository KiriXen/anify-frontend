        ...
        <>
            ...
            <main>
                <div className="relative flex min-h-screen items-center overflow-hidden">
                    ...
                    <Image src={"/girl1.png"} className="absolute z-0 mt-56 hidden w-auto md:inset-0 lg:block lg:opacity-50 xl:opacity-100" width={1000} height={1000} alt="Character" loading="lazy" />
                </div>
            </main>
            <Footer />
        </>
