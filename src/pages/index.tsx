    ...
    return (
        <>
            <Head>
                ...
                <meta property="twitter:title" content={"Kirfy"} />
                ...
                <div className="mb-8 mt-8 flex flex-col justify-center">
                    <div className="mx-auto px-4 py-5 sm:px-0 md:py-16">
                        <div className="text-center">
                            <h1 className="mt-6 text-6xl font-extrabold leading-8 tracking-tight text-white">Kirfy</h1>
                            <p className="text-md mt-8 max-w-2xl text-gray-300 sm:text-lg lg:mx-auto">Watch anime in HD quality seamlessly with easy-to-use features, catch up with your favorite light mangas, and more all in one place.</p>
                        </div>
                    </div>
                    <div className="flex flex-col lg:mt-10 lg:items-center lg:justify-center">
                        ...
                        <div className="mx-auto grid max-w-[85%] grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <div className="rounded-lg bg-background-light p-8">
                                ...
                                <p className="mt-2 text-base text-gray-300">Kirfy has gone through many redesigns to match the best websites out there.</p>
                            </div>
                            <div className="rounded-lg bg-background-light p-8">
                                <div className="flex h-12 w-12 items-center justify-center rounded-md bg-main text-white">
                                    <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                ...
                                <p className="mt-2 text-base text-gray-300">Change Kirfy&apos;s functions to personalize your experience.</p>
                            </div>
                            <div className="rounded-lg bg-background-light p-8">
                                <div className="flex h-12 w-12 items-center justify-center rounded-md bg-main text-white">
                                    <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                        ...
                        <div className="mx-auto mt-24 flex w-full flex-col items-center justify-center rounded-md bg-background-light">
                            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
                                <div className="text-center">
                                    ...
                                    <p className="mt-3 text-base text-gray-400">Using the latest technologies, Kirfy is able to provide a seamless experience for all users.</p>
                                </div>
                                        ...
                                        <li className="md_mt-0 mt-10">
                                            <div className="flex">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <p className="dark_text-gray-400 mt-2 text-base leading-6 text-gray-400">Recoded and redesigned with the most popular anime, and light manga websites in mind over many years.</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li className="md_mt-0 mt-10">
                                            <div className="flex">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <p className="dark_text-gray-400 mt-2 text-base leading-6 text-gray-400">Kirfy is built on the basis of tailoring each feature to what the community wants. Features are added based on what is popular and what is trending in the anime/manga community.</p>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div className="relative mt-12 flex flex-col items-center justify-center">
                            <div className="5xl max-w-10xl mx-auto px-4 sm:max-w-7xl sm:px-6 lg:px-8">
                                <div className="mx-auto max-w-4xl text-center">
                                    ...
                                    <p className="mt-3 text-base text-gray-400">Ever-increasing library of anime, and light mangas.</p>
                                </div>
                            </div>
                            <div className="mt-10">
